...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        <i class="fa fa-envelope-o"></i> <a href="mailto:contact@example.com">contact@bms.com.gn</a>
        <i class="fa fa-phone"></i> +224 623 424 201
      </div>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <!--<h1><a href="#body" class="scrollto">BM<span>S</span></a></h1>-->
        <!-- Uncomment below if you prefer to use an image logo -->
        <a href="#body"><img src="{{asset('template/img/logo.png')}}" alt="" title="" /></a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#portfolio">Nos Expériences</a></li>
          <!--
  ...
  <section id="intro">
    ...
    <div id="intro-carousel" class="owl-carousel" >
      <div class="item" style="background-image: url('{{asset('template/img/im.png')}}');"></div>
      <div class="item" style="background-image: url('{{asset('template/img/intro-carousel/1.jpg')}}');"></div>
      <div class="item" style="background-image: url('{{asset('template/img/intro-carousel/2.jpg')}}');"></div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/1.jpg')}}" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/2.jpg')}}" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/3.jpg')}}" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/4.jpg')}}" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/5.jpg')}}" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/6.jpg')}}" class="portfolio-popup">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/7.jpg')}}" class="portfolio-popup">
                <img src="{{asset('template/img/portfolio/7.jpg')}}" alt="">
                <div class="portfolio-overlay">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="portfolio-item wow fadeInUp">
              <a href="{{asset('template/img/portfolio/8.jpg')}}" class="portfolio-popup">
                <img src="{{asset('template/img/portfolio/8.jpg')}}" alt="">
                <div class="portfolio-overlay">
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>BAFING MULTI SERVICES</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
